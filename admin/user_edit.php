                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="x_panel">
                            <div class="x_title">
                                ...
                                <?php } ?>
                                <?php } ?>
                                <form class="form-horizontal form-label-left" method="post" action="update_user.php">
                                    <?php
                                    $query = "SELECT * FROM users WHERE u_id='".$_REQUEST['u_id']."'";
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-md-9 col-sm-9 ">
                                            <input type="text" class="form-control" id="surname" name="surname" value="<?php echo $row['sur_name']; ?>" placeholder="Enter surname" required>
                                        </div>
                                    </div>
                                    <div class="form-group row ">
                                        <label class="control-label col-md-3 col-sm-3 ">User code</label>
                                        <div class="col-md-9 col-sm-9 ">
                                            <input type="text" class="form-control" id="usercode" name="usercode" value="<?php echo $row['u_code']; ?>" placeholder="Enter user code" required>
                                        </div>
                                    </div>
                                    <div class="form-group row ">
                                        <label class="control-label col-md-3 col-sm-3 ">Username</label>
                                        <div class="col-md-9 col-sm-9 ">
                                            <input type="text" class="form-control" id="username" name="username" value="<?php echo $row['username']; ?>" placeholder="Enter username" required>
                                        </div>
                                    </div>
                                    <div class="form-group row ">
